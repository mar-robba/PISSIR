...
- RF01.4.1: =dispacciaManutenzione= imposta MANUTENZIONE e rimette ONLINE dentro la stessa chiamata,
  senza nessun broadcast in mezzo, quindi quello stato non arriva mai alle schermate. Il requisito
  chiede che la stazione /risulti/ in manutenzione, e questo non succede.
...
- RF01.2.2: la centrale distingue davvero il guasto dedotto da quello segnalato, ma solo al proprio
  interno e con un prefisso nel testo del messaggio. Verso l'operatore le due origini finiscono
  entrambe nel tipo =sensore_offline= e il DTO degli allarmi non porta nessun campo che le separi.
...
- =Transiti=: un treno dentro una stazione, con =tempoEntrata= e =tempoUscita=. La riga
  ...
  quindi finché =tempoUscita= è null il treno è ancora in stazione
...
note right of Senza
  Senza itinerario il convoglio non si muove: il tick esce subito,
  quindi un treno registrato a database ma senza tratta assegnata
  resta fermo e riprova per sempre. La Centrale risponde 404 finche'
  l'operatore non gliene assegna una.
end note
...
Tick --> Attesa : 1. [ricarica richiesta da T9] /\nsvuota l'itinerario e azzera il viaggio
...
**** T5 fase del viaggio
- il cuore della simulazione, cioe' dove si trova il convoglio lungo l'itinerario: comprende il trattenimento per stazione guasta e il ritardo che cresce mentre e' fermo
...
- requisiti coperti: RF02.3.1 e RF01.5 completi lato centrale (convoglio, stazione e orario di entrata e di uscita, a db e in cache), RF03.3 completo perche' e' il punto in cui le due fonti dello stesso passaggio restano trattate separatamente invece di sostituirsi a vicenda, RF02.7 e RF02.2.2.1 parzialmente (onPassaggio aggiorna posizione sulla tratta e prossima stazione)
...
Nessuno --> Aperto : ENTRATA /\ncrea il transito, storicizza,\ntreniInStazione + 1
Aperto --> Chiuso : USCITA /\nvalorizza tempoUscita, storicizza,\ntreniInStazione - 1
