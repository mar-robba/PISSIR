...
\label{sec:org0f16302}
\subsection{Diagrammi degli stati}
\label{sec:org13d519a}
\subsubsection{Del Treno}
\label{sec:orgd307a70}
\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-Ew7jF5/plantuml-VEV2Gg.png}
\label{}
\end{center}
\subsubsection{Della Stazione}
\label{sec:org55e7884}
\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-Ew7jF5/plantuml-hTzMYc.png}
\label{}
\end{center}
\section{Progettazione}
\label{sec:orgbd3f32c}
\subsection{Modello dati}
\label{sec:org989b319}
\subsection{Diagramma delle componenti}
\label{sec:org6f7b2fc}
\begin{center}
\includegraphics[width=.9\linewidth]{./immagini/diagrammaDelleComponenti.png}
\end{center}
\subsection{Diagramma di sequenza}
\label{sec:orgb0248fd}
\end{document}
